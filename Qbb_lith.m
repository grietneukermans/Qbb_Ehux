...
%r0 as in Fig. 2 [microns], this is the inner radius of the coccosphere which relates to the size of the coccoliths as given below 
%nspoke=number of spokes in the coccolith [dim], 
%lambda=light wavelength in water [microns], 
%n=refractive index of the coccolith material, can be real or complex number
...
tt=0.1715*r0;%equivalent disk thickness; a disk of area Pi rm^2 with a thickness tt has the same volume as a Zhai coccolith
...
function Qabs = Qabs(k,t,lambda)
    % this is an approximation to Eq. A4 in the paper that works if you don't have access to the exponential integral function of order 3, expint(3,x)
